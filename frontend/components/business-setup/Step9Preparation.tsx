...
export default function Step9Preparation() {
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-16 items-start pt-4 h-full">
            <div className="flex-1 pt-4">
                <h2 className="text-5xl font-bold text-[#0F172A] mb-2">Approvals</h2>
                <div className="w-16 h-1.5 bg-[#0F172A] rounded-full my-8"></div>
                <p className="mb-10 text-lg text-gray-500">Preparing final approvals and documents.</p>
