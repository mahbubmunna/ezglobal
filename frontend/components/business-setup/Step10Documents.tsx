    ...
    return (
        <div className="flex flex-col lg:flex-row gap-16 items-start pt-4 h-full">
            <div className="flex-1 pt-4">
                <h2 className="text-5xl font-bold text-[#0F172A] mb-2">Final Review</h2>
                <div className="w-16 h-1.5 bg-[#0F172A] rounded-full my-8"></div>
                <p className="mb-10 text-lg text-gray-500">Review all generated legal documents.</p>
            ...
            <div className="flex-1">
                <div className="flex-1 bg-white rounded-[32px] border border-gray-100 h-[400px] flex items-center justify-center p-8">
                    <div className="text-center">
                        <h3 className="text-xl font-bold text-[#0F172A]">Review</h3>
                        <p className="text-gray-400 mt-2">Signatures and final checks.</p>
                    </div>
                </div>
